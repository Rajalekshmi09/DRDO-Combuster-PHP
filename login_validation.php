...
if(isset($data->user_name) 
    ...
    $en_password = md5($password);
        $insertUser = mysqli_query($db_conn,"select username from user where email = '$username' 
        and pwd = '$en_password'");
        if(!$insertUser){
